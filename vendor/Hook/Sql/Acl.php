...
class Acl
{
    ...
    const GET_USER = 'SELECT * FROM `hp_acl_user_role`';
    const GET_GROUP_RESOURCE = 'SELECT * FROM `hp_acl_group_resource`';
    const GET_ROLE_RESOURCE = 'SELECT * FROM `hp_acl_role_resource`';
    const GET_USER_RESOURCE = 'SELECT * FROM `hp_acl_user_resource`';
}