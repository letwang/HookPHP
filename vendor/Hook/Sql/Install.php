...
CREATE TABLE `hp_acl_group` (
  ...
  CONSTRAINT `FK_000026` FOREIGN KEY (`app_id`) REFERENCES `hp_app` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `hp_acl_group_resource` (
  ...
  CONSTRAINT `FK_000001` FOREIGN KEY (`group_id`) REFERENCES `hp_acl_group` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_000002` FOREIGN KEY (`resource_id`) REFERENCES `hp_acl_resource` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `hp_acl_role` (
  ...
  CONSTRAINT `FK_000028` FOREIGN KEY (`app_id`) REFERENCES `hp_app` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `hp_acl_role_resource` (
  ...
  KEY `resource_id` (`resource_id`),
  CONSTRAINT `FK_000003` FOREIGN KEY (`resource_id`) REFERENCES `hp_acl_resource` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_000004` FOREIGN KEY (`role_id`) REFERENCES `hp_acl_role` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `hp_acl_user_resource` (
  ...
  KEY `resource_id` (`resource_id`),
  CONSTRAINT `FK_000005` FOREIGN KEY (`user_id`) REFERENCES `hp_user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_000006` FOREIGN KEY (`resource_id`) REFERENCES `hp_acl_resource` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `hp_acl_user_role` (
  ...
  KEY `role_id` (`role_id`),
  CONSTRAINT `FK_000007` FOREIGN KEY (`role_id`) REFERENCES `hp_acl_role` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_000008` FOREIGN KEY (`user_id`) REFERENCES `hp_user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `hp_config` (
  ...
  CONSTRAINT `FK_000029` FOREIGN KEY (`app_id`) REFERENCES `hp_app` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `hp_hook_module` (
  ...
  CONSTRAINT `FK_000017` FOREIGN KEY (`hook_id`) REFERENCES `hp_hook` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_000018` FOREIGN KEY (`module_id`) REFERENCES `hp_module` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `hp_manager` (
  ...
  CONSTRAINT `FK_000034` FOREIGN KEY (`lang_id`) REFERENCES `hp_lang` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `hp_module` (
  ...
  CONSTRAINT `FK_000033` FOREIGN KEY (`app_id`) REFERENCES `hp_app` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
