...
class Calendar
{
    ...
    public static array $YEAR = ['零','一','二','三','四','五','六','七','八','九'];
    public static array $MONTH = ['','正月','二月','三月','四月','五月','六月','七月','八月','九月','十月','冬月','腊月'];
    public static array $DATE = [
        '','初一','初二','初三','初四','初五','初六','初七','初八','初九','初十','十一','十二','十三','十四','十五',
        '十六','十七','十八','十九','二十','廿一','廿二','廿三','廿四','廿五','廿六','廿七','廿八','廿九','三十','卅一'
    ];
    public static array $ZODIAC = ['猴','鸡','狗','猪','鼠','牛','虎','兔','龙','蛇','马','羊'];
    public static array $SKY = ['庚','辛','壬','癸','甲','乙','丙','丁','戊','己'];
    public static array $EARTH = ['申','酉','戌','亥','子','丑','寅','卯','辰','巳','午','未'];

    //[闰月的月数,农历正月对应的公历月份,农历初一对应的公历天数]
    public static array $LUNARINFO = [
