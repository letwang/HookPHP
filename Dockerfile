...
127.0.0.1 api.admin.com
127.0.0.1 www.iot.com
127.0.0.1 api.iot.com
127.0.0.1 www.paas.com
127.0.0.1 api.paas.com
127.0.0.1 www.payment.com
127.0.0.1 api.payment.com
127.0.0.1 www.store.com
127.0.0.1 api.store.com
EOF
...
server {
	listen  80 ssl http2;
	root html/HookPHP/public/admin/dist/;
	index index.html;
...
server {
	...
	index index.php;
	error_log logs/api.admin.com-error.log;
	access_log logs/api.admin.com-access.log main;
	server_name api.admin.com;
...
server {
	listen  80 ssl http2;
	root html/HookPHP/public/iot/dist/;
	index index.html;
...
server {
	...
	index index.php;
	error_log logs/api.iot.com-error.log;
	access_log logs/api.iot.com-access.log main;
...
server {
	listen  80 ssl http2;
	root html/HookPHP/public/paas/dist/;
	index index.html;
...
server {
	...
	index index.php;
	error_log logs/api.paas.com-error.log;
	access_log logs/api.paas.com-access.log main;
	server_name api.paas.com;
...
server {
	listen  80 ssl http2;
	root html/HookPHP/public/payment/dist/;
	index index.html;
...
server {
	...
	index index.php;
	error_log logs/api.payment.com-error.log;
	access_log logs/api.payment.com-access.log main;
...
server {
	listen  80 ssl http2;
	root html/HookPHP/public/store/dist/;
	index index.html;
...
server {
	...
	index index.php;
	error_log logs/api.store.com-error.log;
	access_log logs/api.store.com-access.log main;
