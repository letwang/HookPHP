...
var advanceDataTables = {
  ...
  handleDataTables: function handleDataTables(ajax, columns) {
    return $('#myTable').DataTable({
      dom: '<\'text-muted\'Bi>\n        <\'table-responsive\'tr>\n        <\'mt-4\'p>',
      buttons: [{text: 'Add', action: function ( e, dt, node, config ) {location.href='/'+ajax.split('/')[2]+'/post/';}}, 'copyHtml5', { extend: 'print', autoPrint: false }],
      language: {
        paginate: {
      ...
      headerCallback: function( thead, data, start, end, display ) {
          $(thead).find('th').eq(0).html('<div class="thead-dd dropdown"><span class="custom-control custom-control-nolabel custom-checkbox"><input type="checkbox" class="custom-control-input" id="check-handle"><label class="custom-control-label" for="check-handle"></label></span><div class="thead-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fa fa-caret-down"></span></div><div class="dropdown-arrow"></div><div class="dropdown-menu"><a class="dropdown-item" href="#!">Select all</a><a class="dropdown-item" href="#!">Unselect all</a><div class="dropdown-divider"></div><a class="dropdown-item" href="#!">Bulk remove</a><a class="dropdown-item" href="#!">Bulk edit</a><a class="dropdown-item" href="#!">Separate actions</a></div></div>');
      },
      columnDefs: [{
          targets: 0,
