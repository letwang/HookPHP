...
$pdo->query(Install::CREATE_SYS_STRUCT);
$pdo->query(Install::CREATE_SYS_DATA);
$pdo->query(str_replace('%s', APP_NAME, Install::CREATE_APP_STRUCT));
$pdo->query(str_replace('%s', APP_NAME, Install::CREATE_APP_DATA));
